// Package weatherforecast provides a Go client for the Weather API.
//
// For more information, visit: https://weatherforecast.apiverve.com?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/weatherforecast"
	defaultTimeout = 30 * time.Second
)

// Client is the Weather API client.
type Client struct {
	apiKey     string
