...
```gradle
dependencies {
    implementation 'com.github.apiverve:weatherforecast-api:1.1.12'
}
```
...
```java
import com.apiverve.weatherforecast.WeatherAPIClient;
import com.apiverve.weatherforecast.APIResponse;
import com.apiverve.weatherforecast.APIException;

// Initialize the client
WeatherAPIClient client = new WeatherAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/weatherforecast](https://docs.apiverve.com/ref/weatherforecast)
...
- **Documentation:** [https://docs.apiverve.com/ref/weatherforecast](https://docs.apiverve.com/ref/weatherforecast)
- **Issues:** [GitHub Issues](https://github.com/apiverve/weatherforecast-api/issues)
