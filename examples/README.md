...
This folder contains example code for using the Weather API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/weatherforecast',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/weatherforecast");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/weatherforecast](https://docs.apiverve.com/ref/weatherforecast)
